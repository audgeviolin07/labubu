    ...
    <section className="py-4 bg-background">
      <nav className="container mx-auto flex items-center justify-between">
        ...
        <NavigationMenu className="hidden lg:block">
          <NavigationMenuList
            ref={menuRef}
            className="rounded-full flex items-center gap-6 px-8 py-3 bg-surface/50"
          >
            {NAV_ITEMS.map((item) => (
            ...
            >
              <div className="bg-primary h-0.5 w-full rounded-full transition-all duration-300" />
            </div>
          </NavigationMenuList>
        </NavigationMenu>
        ...
        <div className="hidden items-center gap-2 lg:flex">
          <Button
            className="h-10 py-2.5 text-sm font-medium bg-primary hover:bg-accent text-white rounded-full px-6"
          >
            Start Rating
          </Button>
        </div>
  ...
  return (
    <div className="block lg:hidden">
      <Popover open={isOpen} onOpenChange={setIsOpen}>
        ...
        <PopoverContent
          align="end"
          className="relative -left-4 -top-4 block w-screen max-w-md overflow-hidden rounded-2xl p-0 lg:hidden"
        >
